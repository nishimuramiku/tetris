...
void GameOverScene::Init(Device* device, const FLOAT aspectRatio)
{
...
bool GameOverScene::Update(Device* device)
{
	device->Begin();
	...
	oinusama->Init(m_pDevice, m_pDeviceContext, L"gameOver.png", 0, 0, DirectX::XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f));
